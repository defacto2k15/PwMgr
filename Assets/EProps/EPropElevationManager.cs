...
namespace Assets.EProps
{
    ...
    {
        private Dictionary<HeightPyramidLevel, Vector2> _floorTextureWorldSizes;
        private Dictionary<HeightPyramidLevel, Dictionary<int, Vector2>> _ringMergeRanges;

        public EPropHotAreaSelector(Dictionary<HeightPyramidLevel, Vector2> floorTextureWorldSizes, Dictionary<HeightPyramidLevel, Dictionary<int, Vector2>> ringMergeRanges)
        {
            _floorTextureWorldSizes = floorTextureWorldSizes;
