...
{
    class IndirectMeshDrawingDebugObject : MonoBehaviour
    {
        ...
        void Start()
        {
            instanceMesh = GameObject.CreatePrimitive(PrimitiveType.Cube).GetComponent<MeshFilter>().mesh;
            instanceMaterial = new Material(Shader.Find("Instanced/InstancedSurfaceShader"));
        ...
        void Update()
        {
            ...
            Graphics.DrawMeshInstancedIndirect(instanceMesh, 0, instanceMaterial,
                new Bounds(Vector3.zero, new Vector3(10.0f, 10.0f, 10.0f)), argsBuffer);
        }

        void OnGUI()
        {
            GUI.Label(new Rect(265, 25, 200, 30), "Instance Count: " + instanceCount.ToString());
            instanceCount = (int) GUI.HorizontalSlider(new Rect(25, 20, 200, 30), (float) instanceCount, 1.0f,
                5000000.0f);
        }
