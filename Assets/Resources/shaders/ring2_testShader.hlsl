...
#define MAX_LAYER_COUNT (4)
				...
				float2 turncatedInputPos = fmod(flatPos, 1000);
					...
					layerOutput[layerIndex] = getBaseFlatTerrain(new_TextureLayerInput(palette, strength, _DetailComplexity, turncatedInputPos, float3(0,0,1)));
					layerIndex++;
				#endif
					...
					layerOutput[layerIndex] = getDrySand( new_TextureLayerInput( palette, strength, _DetailComplexity, turncatedInputPos , float3(0,0,1)));
					layerIndex++;
				#endif
				#ifdef OT_GRASS
					...
					layerOutput[layerIndex] = getGrassyField( new_TextureLayerInput( palette, strength, _DetailComplexity,  turncatedInputPos, float3(0,0,1)));
					layerIndex++;
				#endif
				#ifdef OT_DOTS
					...
					layerOutput[layerIndex] = getDottedTerrain( new_TextureLayerInput( palette, strength, _DetailComplexity, turncatedInputPos, float3(0,0,1)));
					layerIndex++;
				#endif
