...
Shader "Custom/Nature/Tree Creator Leaves Optimized Ugly" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf BlinnPhong alphatest:_Cutoff vertex:MyTreeVertLeaf addshadow
		...
		void surf (Input IN, inout  SurfaceOutput o) {
			...
			o.Albedo = c.rgb * IN.color.rgb * IN.color.a * 1.5 * (1-trngls.b/2);
