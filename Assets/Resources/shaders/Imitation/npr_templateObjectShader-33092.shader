Shader "Custom/NPR/IMITATION/Template/ObjectShader--33092" {
    Properties {
...
#define IN_ridge_FEATURE_APPLY_MODE (2)
#define IN_valley_FEATURE_APPLY_MODE (2)
...
#define IN_sc_FEATURE_DETECTION_MODE DETECTION_MODE_VERTEX
#define IN_sc_FEATURE_APPLY_MODE APPLY_MODE_FILLING
...
#define IN_scpp_FEATURE_DETECTION_MODE (3)
#define IN_scpp_FEATURE_APPLY_MODE (3)

#define IN_happ_FEATURE_DETECTION_MODE DETECTION_MODE_PIXEL
#define IN_happ_FEATURE_APPLY_MODE APPLY_MODE_FILLING

#define IN_dn_FEATURE_DETECTION_MODE DETECTION_MODE_PIXEL
#define IN_dn_FEATURE_APPLY_MODE APPLY_MODE_FILLING
...
#define FEATURE1( a )  a(scpp)
#define FEATURE2( a )  a(ridge)
#define FEATURE3( a )  a(valley)
#define FEATURE4( a )  
#define FEATURE5( a )  
#define FEATURE6( a )  
#define FEATURE7( a )  
