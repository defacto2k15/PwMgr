Shader "Custom/NPR/IMITATION/Template/PPShader--5872696" {
	Properties
	{
...
#define IN_filter0_COLOR float4(1, 0, 0, 0)
#define IN_filter0_TRESHOLD _DebugSlider
#define IN_filter0_DESTINATION_TEXTURE_INDEX 0
#define IN_filter0_DESTINATION_TEXTURE_SUFFIX rgba
#define IN_filter1_COLOR float4(0, 1, 0, 0)
#define IN_filter1_TRESHOLD _DebugSlider
