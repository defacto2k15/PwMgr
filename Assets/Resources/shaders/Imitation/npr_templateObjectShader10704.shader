Shader "Custom/NPR/IMITATION/Template/ObjectShader-10704" {
    Properties {
...
//IMITATION UNIFORMS PROPERTY START
		...
		_ph_TestDerivativeCutoff("ph_TestDerivativeCutoff", Range(0, 500)) =3 //T=4.2
...
#define IN_happ_FEATURE_DETECTION_MODE (3)
#define IN_happ_FEATURE_APPLY_MODE (3)
