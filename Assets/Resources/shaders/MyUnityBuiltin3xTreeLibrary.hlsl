...
#ifndef MY_UNITY_BUILTIN_3X_TREE_LIBRARY_INCLUDED
#define MY_UNITY_BUILTIN_3X_TREE_LIBRARY_INCLUDED
...
void MyTreeVertBark (inout appdata_full v, out Input o)
{
...
void MyTreeVertLeaf (inout appdata_full v, out Input o)
{
	UNITY_INITIALIZE_OUTPUT(Input, o);
